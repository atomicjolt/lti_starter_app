namespace :canvas do
  ...
  class CanvasApiBuilder
    ...
    def self.build
      ...
      Render.new("./canvas_api/js_urls.erb", nil, nil, nil, nil, nil, canvas_urls_js, nil).save("#{Rails.root}/../atomic-lti/apps/lib/canvas/urls.js")

      Render.new("./canvas_api/graphql_types.erb", nil, nil, nil, nil, nil, models.compact, nil).save("#{Rails.root}/../atomic-lti/apps/lib/canvas/graphql_types.js")
      Render.new("./canvas_api/graphql_queries.erb", nil, nil, nil, nil, nil, queries, nil).save("#{Rails.root}/../atomic-lti/apps/lib/canvas/graphql_queries.js")
      Render.new("./canvas_api/graphql_mutations.erb", nil, nil, nil, nil, nil, mutations, nil).save("#{Rails.root}/../atomic-lti/apps/lib/canvas/graphql_mutations.js")
    end
