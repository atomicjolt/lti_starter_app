...
describe('parseParams', () => {
  it('parses params from the given url into an object', () => {
    const nextUrl = 'https://atomicjolt.instructure.com/api/v1/courses/244/assignments?page=2&per_page=10';
    const params = parseParams(nextUrl);
    expect(params).toEqual({ page: '2', per_page: '10' });
  });
  it('has not params to parse', () => {
    const nextUrl = 'https://atomicjolt.instructure.com/api/v1/courses/244/assignments';
    const params = parseParams(nextUrl);
