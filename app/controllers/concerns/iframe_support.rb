  ...
  module IframeSupport
    ...
    def check_for_user_auth
      ...
      if !@tool_provider.context_student?
        unless current_user.authentications.find_by(provider_url: current_application_instance.lti_consumer_uri)
          ...
          redirect_to user_canvas_omniauth_authorize_path(:canvas_url => current_application_instance.lti_consumer_uri)
        end
      end
    end
