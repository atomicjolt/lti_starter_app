...
describe ApplicationHelper do
  ...
  describe "#canvas_url" do
    it "provides the canvas url from settings" do
      ...
      # directly on the object. current_lti_application_instance lives in the application controller
      ...
      helper.class.instance_eval do
        define_method(:current_lti_application_instance) { lti_application_instance }
      end

      expect(helper.canvas_url).to eq(lti_application_instance.lti_consumer_uri)
    end
  end
