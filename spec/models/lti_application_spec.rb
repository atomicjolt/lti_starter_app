...
RSpec.describe LtiApplication, type: :model do
  ...
  describe "create lti application" do
    ...
    it "sets a default lti key" do
      name = "test"
      app = described_class.create!(name: name, lti_consumer_uri: @lti_consumer_uri)
      expect(app.lti_key).to eq(name)
    end

    it "sets a default secret" do
      app = described_class.create!(name: "test", lti_consumer_uri: @lti_consumer_uri)
    ...
    it "requires a name" do
      expect {
        described_class.create!(lti_consumer_uri: @lti_consumer_uri)
