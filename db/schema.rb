...
ActiveRecord::Schema[7.0].define(version: 2022_03_31_000624) do
  ...
  create_table "accommodations", force: :cascade do |t|
    t.string "sis_id"
    t.string "course_crn"
    t.datetime "date_requested", precision: nil
  ...
  create_table "application_instances", force: :cascade do |t|
    ...
    t.datetime "license_start_date", precision: nil
    t.datetime "license_end_date", precision: nil
    t.datetime "trial_start_date", precision: nil
    t.datetime "trial_end_date", precision: nil
    t.text "license_notes"
    t.text "trial_notes"
    t.integer "licensed_users"
    t.integer "trial_users"
    t.string "canvas_token_2"
    t.string "canvas_token_2_iv"
    t.string "canvas_token_2_salt"
  end
  ...
  create_table "assignment_users", force: :cascade do |t|
    ...
    t.string "token"
    t.datetime "submitted_to_lms_at", precision: nil
  ...
  create_table "attempts", force: :cascade do |t|
    ...
    t.datetime "last_scored_at", precision: nil
    t.float "decimal_score"
    t.float "manual_score"
    t.float "total_score"
    t.float "total_max_score"
    t.datetime "unscorable_at", precision: nil
    t.string "lrn_score_job_id"
    t.datetime "additional_time_started_at", precision: nil
    t.float "ability_score"
    t.boolean "graded"
    t.datetime "last_attempted_at", precision: nil
    t.datetime "time_limit_expires_at", precision: nil
  ...
  create_table "authentications", force: :cascade do |t|
    ...
    t.string "token_2"
    t.string "token_2_iv"
    t.string "token_2_salt"
    t.string "secret_2"
    t.string "secret_2_iv"
    t.string "secret_2_salt"
    t.string "refresh_token_2"
    t.string "refresh_token_2_iv"
    t.string "refresh_token_2_salt"
  end
  ...
  create_table "canvas_courses", force: :cascade do |t|
    ...
    t.datetime "enable_authoring_at", precision: nil
  ...
  create_table "lti_installs", id: false, force: :cascade do |t|
  ...
  create_table "lti_launches", id: false, force: :cascade do |t|
    t.bigserial "id", null: false
    t.jsonb "config"
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  ...
  create_table "oauth_states", id: false, force: :cascade do |t|
    t.bigserial "id", null: false
    t.string "state"
    t.text "payload"
    t.datetime "created_at", precision: nil, null: false
  ...
  create_table "open_id_states", id: false, force: :cascade do |t|
    t.bigserial "id", null: false
    t.string "nonce"
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  ...
  create_table "que_jobs", id: false, comment: "5", force: :cascade do |t|
  ...
  create_table "que_lockers", id: false, force: :cascade do |t|
  ...
  create_table "que_values", id: false, force: :cascade do |t|
    t.text "key", null: false
    t.jsonb "value", default: {}, null: false
    t.check_constraint "jsonb_typeof(value) = 'object'::text", name: "valid_value"
  end

  create_table "request_statistics", id: false, force: :cascade do |t|
    t.datetime "truncated_time", precision: nil, null: false
  ...
  create_table "request_user_statistics", id: false, force: :cascade do |t|
    t.datetime "truncated_time", precision: nil, null: false
    t.string "tenant", null: false
